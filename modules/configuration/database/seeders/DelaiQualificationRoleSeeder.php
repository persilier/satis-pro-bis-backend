...
class DelaiQualificationRoleSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $permission_list = Permission::create(['name' => 'list-delai-qualification-parameters', 'guard_name' => 'api']);
        $permission_show = Permission::create(['name' => 'show-delai-qualification-parameters', 'guard_name' => 'api']);
        $permission_store = Permission::create(['name' => 'store-delai-qualification-parameters', 'guard_name' => 'api']);
        $permission_destroy= Permission::create(['name' => 'destroy-delai-qualification-parameters', 'guard_name' => 'api']);
