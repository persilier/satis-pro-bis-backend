...
namespace Satis2020\CategoryClient\Database\Seeders;
...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission_list = Permission::create(['name' => 'list-category-client', 'guard_name' => 'api']);
        $permission_store = Permission::create(['name' => 'store-category-client', 'guard_name' => 'api']);
        $permission_update = Permission::create(['name' => 'update-category-client', 'guard_name' => 'api']);
        $permission_destroy = Permission::create(['name' => 'destroy-category-client', 'guard_name' => 'api']);
        $permission_show = Permission::create(['name' => 'show-category-client', 'guard_name' => 'api']);
