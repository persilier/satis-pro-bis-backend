...
namespace Satis2020\AccountType\Database\Seeders;
 ...
 * @package Satis2020\AccountType\Database\Seeders
 */
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission_list = Permission::create(['name' => 'list-account-type', 'guard_name' => 'api']);
        $permission_store = Permission::create(['name' => 'store-account-type', 'guard_name' => 'api']);
        $permission_update = Permission::create(['name' => 'update-account-type', 'guard_name' => 'api']);
        $permission_destroy = Permission::create(['name' => 'destroy-account-type', 'guard_name' => 'api']);
        $permission_show = Permission::create(['name' => 'show-account-type', 'guard_name' => 'api']);
