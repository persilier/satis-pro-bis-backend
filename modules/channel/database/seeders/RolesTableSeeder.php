...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission_list = Permission::create(['name' => 'list-channel', 'guard_name' => 'api']);
        $permission_store = Permission::create(['name' => 'store-channel', 'guard_name' => 'api']);
        $permission_update = Permission::create(['name' => 'update-channel', 'guard_name' => 'api']);
        $permission_destroy = Permission::create(['name' => 'destroy-channel', 'guard_name' => 'api']);
        $permission_show = Permission::create(['name' => 'show-channel', 'guard_name' => 'api']);
