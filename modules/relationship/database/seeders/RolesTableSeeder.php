...
namespace Satis2020\Relationship\Database\Seeders;
...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission_list = Permission::create(['name' => 'list-relationship', 'guard_name' => 'api']);
        $permission_store = Permission::create(['name' => 'store-relationship', 'guard_name' => 'api']);
        $permission_update = Permission::create(['name' => 'update-relationship', 'guard_name' => 'api']);
        $permission_destroy = Permission::create(['name' => 'destroy-relationship', 'guard_name' => 'api']);
        $permission_show = Permission::create(['name' => 'show-relationship', 'guard_name' => 'api']);
