...
namespace Satis2020\ClaimCategory\Database\Seeders;
...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission_list = Permission::create(['name' => 'list-claim-category', 'guard_name' => 'api']);
        $permission_store = Permission::create(['name' => 'store-claim-category', 'guard_name' => 'api']);
        $permission_update = Permission::create(['name' => 'update-claim-category', 'guard_name' => 'api']);
        $permission_destroy = Permission::create(['name' => 'destroy-claim-category', 'guard_name' => 'api']);
        $permission_show = Permission::create(['name' => 'show-claim-category', 'guard_name' => 'api']);
