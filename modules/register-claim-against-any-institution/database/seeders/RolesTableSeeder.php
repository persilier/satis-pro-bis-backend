...
namespace Satis2020\RegisterClaimAgainstAnyInstitution\Database\Seeders;
...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // create permissions
        $permission_store = Permission::create(['name' => 'store-claim-against-any-institution', 'guard_name' => 'api']);
