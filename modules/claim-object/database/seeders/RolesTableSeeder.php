...
namespace Satis2020\ClaimObject\Database\Seeders;
...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission_list = Permission::create(['name' => 'list-claim-object', 'guard_name' => 'api']);
        $permission_store = Permission::create(['name' => 'store-claim-object', 'guard_name' => 'api']);
        $permission_update = Permission::create(['name' => 'update-claim-object', 'guard_name' => 'api']);
        $permission_destroy = Permission::create(['name' => 'destroy-claim-object', 'guard_name' => 'api']);
        $permission_show = Permission::create(['name' => 'show-claim-object', 'guard_name' => 'api']);
