...
namespace Satis2020\AnyInstitutionTypeRole\Providers;
 ...
 */
class AnyInstitutionTypeRoleServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        return [
            'namespace' => 'Satis2020\AnyInstitutionTypeRole\Http\Controllers',
            'middleware' => ['api']
        ];
    }
