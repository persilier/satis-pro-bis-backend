...
namespace Satis2020\SearchClaimMyReference\Http\Controllers\Search;
...
class SearchController extends ApiController
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:search-claim-my-reference')->only(['index']);
    }
    ...
    {
        return response()->json($this->searchClaim($reference, true), 200);
    }
