...
namespace Satis2020\Currency\Database\Seeders;
...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission_list = Permission::create(['name' => 'list-currency', 'guard_name' => 'api']);
        $permission_store = Permission::create(['name' => 'store-currency', 'guard_name' => 'api']);
        $permission_update = Permission::create(['name' => 'update-currency', 'guard_name' => 'api']);
        $permission_destroy = Permission::create(['name' => 'destroy-currency', 'guard_name' => 'api']);
        $permission_show = Permission::create(['name' => 'show-currency', 'guard_name' => 'api']);
