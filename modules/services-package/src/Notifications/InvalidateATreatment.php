...
class InvalidateATreatment extends Notification implements ShouldQueue
{
    ...
    public function __construct($claim)
    {
        ...
        $this->event = $this->getNotification('invalidate-a-treatment');
