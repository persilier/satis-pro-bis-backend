...
namespace Satis2020\AnyInstitution\Database\Seeders;
...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission_list = Permission::create(['name' => 'list-any-institution', 'guard_name' => 'api']);
        $permission_store = Permission::create(['name' => 'store-any-institution', 'guard_name' => 'api']);
        $permission_update = Permission::create(['name' => 'update-any-institution', 'guard_name' => 'api']);
        $permission_destroy = Permission::create(['name' => 'destroy-any-institution', 'guard_name' => 'api']);
        $permission_show = Permission::create(['name' => 'show-any-institution', 'guard_name' => 'api']);
