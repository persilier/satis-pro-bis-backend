<?php
namespace Satis2020\MobileApi\Providers;
use Illuminate\Support\ServiceProvider;
use Illuminate\Support\Facades\Route;
use Satis2020\ServicePackage\Traits\ApiResponser;

/**
 * Class MobileApiServiceProvider
 * @package Satis2020\MobileApi\Providers
 */
class MobileApiServiceProvider extends ServiceProvider
{
    ...
    {
        return [
            'namespace' => 'Satis2020\MobileApi\Http\Controllers',
            'middleware' => ['api']
        ];
    }
