...
namespace Satis2020\SeverityLevel\Database\Seeders;
...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission_list = Permission::create(['name' => 'list-severity-level', 'guard_name' => 'api']);
        $permission_store = Permission::create(['name' => 'store-severity-level', 'guard_name' => 'api']);
        $permission_update = Permission::create(['name' => 'update-severity-level', 'guard_name' => 'api']);
        $permission_destroy = Permission::create(['name' => 'destroy-severity-level', 'guard_name' => 'api']);
        $permission_show = Permission::create(['name' => 'show-severity-level', 'guard_name' => 'api']);
